    ...
    return(
        ...
        <aside className={`transition-all duration-300 w-80 h-full fixed -left-80 top-0 bottom-0 shadow-md shadow-black z-[1200] ${toogleAsideMenu ? "translate-x-80": " invisible"}`}>
            <div className="bg-wendys-background flex flex-col">
                ...
                <div className="flex flex-row h-30 justify-between items-start pt-4 px-6">
                    ...
                    <div className="w-1/4 flex flex-col items-center cursor-pointer" onClick={()=>setToogleAsideMenuHandler(false)}>
                        ...
                        <h2 className=" font-wendysSimpleFont text-white">CLOSE</h2>
                    </div>

                </div>

                <h2 className=" font-wendysFont px-2 py-4 w-full text-3xl text-justify text-white uppercase"> WENDY'S empleos </h2>
            ...
            <ul className="bg-white min-h-full flex flex-col items-start p-4 text-lg text-wendys-blue font-bold">
                ...
                <Link to={"/plazas"} className="m-3"> <li>Plazas disponibles</li></Link>
                <Link to={"/contactos"} className="m-3"> <li>Contactanos</li></Link>
