        ...
        <main className=" bg-white text-kfc-gray flex flex-col lg:flex-row py-16 pt-8 items-center justify-around">
            ...
            <div className="md:hidden">
                ...
                <div className="mb-8">
                    ...
                    <div>seleccionpartners@starbucks.com.sv</div>
                </div>
                <div className="mb-8">

                    <div className="font-bold ">Guatemala</div>
                    <div>tracing@starbucks.com.gt</div>
                </div>

                <div className="mb-8">

                    <div className="font-bold ">Costa Rica</div>
                    <div>seleccionpartnerspa@starbucks.co.cr</div>
                </div>
                <div>
                    <div className="font-bold ">Panamá</div>
                    <div>seleccionpartnerspa@starbucks.pa</div>
                </div>
            </div>
