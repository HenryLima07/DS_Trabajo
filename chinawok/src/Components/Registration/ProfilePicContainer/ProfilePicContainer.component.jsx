                ...
                <div className="flex flex-col items-center border border-gray-200 rounded-md">
                    ...
                    <div className="w-52 flex flex-col items-center p-4">
                        {
                            OpenCamera || picture ?
                                OpenCamera ? 
                                    ...
                                    :   <></>
                                :
                                <img src={chinaGray} alt="background wendys icon" />
                        }
                    ...
                    <div className="w-full mt-4 flex flex-col items-center bg-gray-200 p-4">
                       ...
                       <FileUploadComponent onChange={onChangeHandler}></FileUploadComponent> 
                        ...
                        {
                            OpenCamera ? 
                                <label htmlFor="" className="bg-chinaButtons text-white py-4 px-8 rounded cursor-pointer" onClick={takePhotoHandler}>Tomar foto</label>
                                :
                                <label className="bg-chinaButtons text-white py-4 px-6 rounded cursor-pointer" onClick={()=>setOpenCameraHandler(true)}>Abrir camara</label>
                        }
