...
{/* TODO: add imagehere */}
                    ...
                    <div className="w-full mt-4 flex flex-col items-center border-t-8 p-4">
                       ...
                       <FileUploadComponent onChange={onChangeHandler}></FileUploadComponent> 
                        ...
                        {
                            OpenCamera ? 
                                <label htmlFor="" className="bg-pizzaRed text-white py-4 px-8 rounded cursor-pointer" onClick={takePhotoHandler}>Tomar foto</label>
                                :
                                <label className="bg-pizzaRed text-white py-4 px-6 rounded cursor-pointer" onClick={()=>setOpenCameraHandler(true)}>Abrir camara</label>
                        }
