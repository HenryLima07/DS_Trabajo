...
const BeneficiosContainer = ()=>{
    return(
        <section className="w-100 p-0 m-0">
            ...
            <article className="bg-[#029cd433] flex flex-col lg:flex-row pr-10 lg:pr-16 py-10">
                ...
                <div className="ml-10 lg:w-2/5 lg:ml-32 mb-10">
                    <p className="text-red-700 text-4xl sm:text-5xl font-wendysSimpleFont ">Beneficios</p>
                </div>
        ...
        <article
            className="grid justify-center justify-items-center grid-cols-3 md:px-20 sm:grid-cols-3 md:grid-cols-6 pb-8 bg-[url('/img/wendys/cuadros-valores.png')]">
            <img src={IconBeneficio01}  className="img-fluid w-[70%]" alt="" />
            <img src={IconBeneficio02}  className="img-fluid w-[70%]" alt="" />
            <img src={IconBeneficio03}  className="img-fluid w-[70%]" alt="" />
            <img src={IconBeneficio04}  className="img-fluid w-[70%]" alt="" />
            <img src={IconBeneficio05}  className="img-fluid w-[70%]" alt="" />
            <img src={IconBeneficio06}  className="img-fluid w-[70%]" alt="" />
        </article>
    </section>
    );
}
